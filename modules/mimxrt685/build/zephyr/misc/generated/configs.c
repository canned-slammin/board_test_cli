...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_SOC_SERIES_IMXRT_6XX, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DT_HAS_NXP_DMIC_ENABLED, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DT_HAS_NXP_IMX_FLEXSPI_MX25UM51345G_ENABLED, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DT_HAS_NXP_LPC_RTC_ENABLED, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DT_HAS_NXP_LPCIP3511_ENABLED, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DT_HAS_NXP_PCA9420_ENABLED, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DT_HAS_WOLFSON_WM8904_ENABLED, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BOARD_MIMXRT685_EVK, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BOARD_MIMXRT685_EVK_MIMXRT685S_CM33, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_SOC_SERIES_IMXRT6XX, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_SOC_MIMXRT685S, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_SRAM_BASE_ADDRESS, 0x10180000);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_ADC_MCUX_LPADC, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_LPADC_CHANNEL_COUNT, 15);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_I2C_MCUX_FLEXCOMM, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_PWM_MCUX_SCTIMER, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_REGULATOR_PCA9420, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_REGULATOR_PCA9420_COMMON_INIT_PRIORITY, 75);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_REGULATOR_PCA9420_INIT_PRIORITY, 76);
